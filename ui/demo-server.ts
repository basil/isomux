  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        kind: "tool_call",
        content: "Bash",
        metadata: { toolId: "tool-dwight-1", input: { command: "find /perimeter -name '*.sensor' -exec test-status {} \\;" } },
      },
      {
        kind: "tool_result",
        content:
    ...
    entries: [
      ...
      },
      {
        ...
        metadata: {
          ...
          input: { command: "find ~/accounting/cats/photos -type f \\( -name '*.jpg' -o -name '*.png' \\) | wc -l" },
        },
      },
      ...
      },
      {
        ...
        metadata: {
          ...
          input: { command: "cd ~/accounting/cats/photos && md5sum *.jpg *.png | sort | uniq -d -w 32" },
        },
      },
    ],
  },
