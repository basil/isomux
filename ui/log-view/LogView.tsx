  ...
  return (
    ...
    >
          ...
          >
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                {logs.length > 0 && (
                  <CopyButton getText={getConversationText} />
                )}
                <button
              ...
              <div style={{ position: "relative", flexShrink: 0 }}>
                ...
                {showMicHint && (
                  ...
                  >
                    ...
                    >
                      Restart isomux and reload this page. You'll be
                      auto-redirected to HTTPS.
                    </div>
                    <button
      ...
      {features.terminal && !isMobile && terminalOpen && (
        <div
          style={{ width: "40%", minWidth: 300, maxWidth: 600, flexShrink: 0 }}
        >
          <TerminalPanel
            agentId={agent.id}
