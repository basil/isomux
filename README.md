...
- Works locally or as a **persistent server** (Mac Mini style):
  - Run at home, access **from any device** in your [Tailscale](https://tailscale.com/) network. Just go to `http://YOUR_TAILSCALE_ALIAS:4000`
...
See [isomux.com](https://isomux.com) for details and setup instructions.
